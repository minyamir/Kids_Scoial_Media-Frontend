...
const BottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#050505]/95 backdrop-blur-2xl border-t border-white/5 h-20 flex items-center justify-around px-4 z-[100]">
      ...
      {/* 🏺 Center Upload Button (Patriotic Style) */}
      ...
      >
        ...
        {/* Notification Badge */}
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 bg-red-600 text-white text-[9px] font-black min-w-[16px] h-4 px-1 rounded-full flex items-center justify-center border-2 border-[#050505] animate-in zoom-in duration-300">
